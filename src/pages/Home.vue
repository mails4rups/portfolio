<template>
 <div>
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Rupam Jana</h1>
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						<h2>let’s <br>
							...
							myself</h2>
						<p>
						 I'm a software developer by profession based in Kolkata, India who enjoys building things that live on the internet. I develop exceptional websites and web apps that provide intuitive, pixel-perfect user interfaces with efficient and modern backends.
						</p>
						<p>
							I work as a freelancer from past 4 years and after qualifing my post graduation I worked for reknowed software establishment as a software developer for both front and back-end
						</p>
			...
			<div class="row feature_inner">
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
						...
						<p>Bring your business idea I'll make it digital.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
						<img src="../assets/img/services/s2.png" alt="">
						<h4>Native & Hybrid App</h4>
						<p>Creating your app in such a way that it can be used in any mobile platform.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
						...
						<p>Creating and integrating custom API as well as third party API.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item">
						...
						<h4>IT Consultant</h4>
						<p>Your business need a proper boost in digital world, I am always there for you.</p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="http://westbengaltchoukball.com/" target="_blank">West Bengal Tchoukball Association</a></h4>
								<p>Web Application</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="https://vespac.com/" target="_blank">Vespac</a></h4>
								<p>ECommerce,CRM,API</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all latest">
	...
	<section class="newsletter_area">
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-12">
					<div class="subscription_box text-center">
						<h2 class="text-uppercase text-white">Lets' get in touch</h2>
						<p class="text-white">
							Provide your email here I will contact you shortly. 
						</p>
						<div class="subcribe-form" id="mc_embed_signup">
							<form target="_blank" novalidate="true" class="subscription relative">
								<input name="EMAIL" placeholder="Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required="" type="email">
								<div style="position: absolute; left: -5000px;">
									<input name="b_36c4fd991d266f23781ded980_aefe40901a" tabindex="-1" value="" type="text">
								</div>
								<button class="primary-btn hover d-inline">Say Hello</button>
								<div class="info"></div>
							</form>
						</div>
					</div>
     ...
     <Loader v-bind:show="this.showLoader"></Loader>
 </div>
...
import { ADDR, WEBSERVICE, PAGE } from "../utils/init";
